class Api::V1::BreedSerializer < ActiveModel::Serializer
  ...
  def best_matches
    ...
    all_breeds.map do |breed|
      breed_hash = breed.as_json
      similarity_score = calculate_similarity_score(breed_hash)
      { breed: breed_hash, similarity_score: similarity_score }
